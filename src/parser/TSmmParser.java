...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		RULE_type = 8, RULE_recordFields = 9, RULE_statement = 10, RULE_local_block = 11, 
		RULE_func_invocation = 12, RULE_expression_list = 13, RULE_block = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "definition", "var_definition", "func_definition", "arguments", 
			"main_definition", "func_body", "expression", "type", "recordFields", 
			"statement", "local_block", "func_invocation", "expression_list", "block"
		};
	}
	...
	public final Func_bodyContext func_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 221920960381504L) != 0)) {
				{
				{
				setState(133);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				{
				setState(288);
				((StatementContext)_localctx).b = local_block();
				_localctx.ast.add(((StatementContext)_localctx).b.ast);
				}
				break;
			}
		}
	...
	public final Local_blockContext local_block() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_local_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(293);
			((Local_blockContext)_localctx).l = match(T__8);
			setState(302);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 221920960381506L) != 0)) {
				{
				setState(300);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
				case T__0:
					{
					setState(294);
					((Local_blockContext)_localctx).var_definition = var_definition();
					_localctx.statements.addAll(((Local_blockContext)_localctx).var_definition.ast);
					}
					break;
				case T__5:
				case T__8:
				...
				case ID:
					{
					setState(297);
					((Local_blockContext)_localctx).statement = statement();
					_localctx.statements.addAll(((Local_blockContext)_localctx).statement.ast);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			setState(305);
			match(T__9);
			((Local_blockContext)_localctx).ast =  new BlockStatement(((Local_blockContext)_localctx).l.getLine(), ((Local_blockContext)_localctx).l.getCharPositionInLine()+1, _localctx.statements);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
