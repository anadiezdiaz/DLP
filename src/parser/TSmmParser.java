...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, INT_CONSTANT=41, SIMPLE_COMMENT=42, MULTIPLE_COMMENT=43, 
		CHAR_CONSTANT=44, WHITESPACES=45, EXP=46, REAL_CONSTANT=47, ID=48;
	public static final int
		...
		RULE_type = 8, RULE_recordFields = 9, RULE_statement = 10, RULE_forblock = 11, 
		RULE_forstmnt = 12, RULE_func_invocation = 13, RULE_expression_list = 14, 
		RULE_block = 15;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "definition", "var_definition", "func_definition", "arguments", 
			"main_definition", "func_body", "expression", "type", "recordFields", 
			"statement", "forblock", "forstmnt", "func_invocation", "expression_list", 
			"block"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "INT_CONSTANT", "SIMPLE_COMMENT", "MULTIPLE_COMMENT", 
	...
	public final Func_bodyContext func_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 444022309191744L) != 0)) {
				{
				{
				setState(135);
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public Func_invocationContext f;
		public ForstmntContext s1;
		public ForstmntContext s2;
		public ForblockContext f1;
		public Expression_listContext expression_list() {
		...
		public List<ForstmntContext> forstmnt() {
			return getRuleContexts(ForstmntContext.class);
		}
		public ForstmntContext forstmnt(int i) {
			return getRuleContext(ForstmntContext.class,i);
		}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				match(T__5);
				setState(292);
				((StatementContext)_localctx).s1 = forstmnt();
				setState(293);
				match(T__3);
				setState(294);
				((StatementContext)_localctx).e1 = expression(0);
				...
				match(T__3);
				setState(296);
				((StatementContext)_localctx).s2 = forstmnt();
				setState(297);
				match(T__6);
				setState(298);
				((StatementContext)_localctx).f1 = forblock();
				_localctx.ast.add(new ForStatement(((StatementContext)_localctx).e1.ast.getLine(), ((StatementContext)_localctx).e1.ast.getColumn(), ((StatementContext)_localctx).s1.ast, ((StatementContext)_localctx).e1.ast, ((StatementContext)_localctx).s2.ast, ((StatementContext)_localctx).f1.ast));
				}
				break;
			}
		}
	...
	public final ForblockContext forblock() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 444022309191744L) != 0)) {
				...
				{
				setState(304);
				((ForblockContext)_localctx).statement = statement();
				_localctx.ast.addAll(((ForblockContext)_localctx).statement.ast);
				}
				}
				setState(311);
				_errHandler.sync(this);
	...
	public final ForstmntContext forstmnt() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_forstmnt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(314);
			((ForstmntContext)_localctx).e1 = expression(0);
			setState(315);
			match(T__34);
			setState(316);
			((ForstmntContext)_localctx).e2 = expression(0);
			((ForstmntContext)_localctx).ast = new Assignment(((ForstmntContext)_localctx).e1.ast.getLine(), ((ForstmntContext)_localctx).e1.ast.getColumn(), ((ForstmntContext)_localctx).e1.ast, ((ForstmntContext)_localctx).e2.ast);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Func_invocationContext func_invocation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 442003674562624L) != 0)) {
				{
				setState(321);
