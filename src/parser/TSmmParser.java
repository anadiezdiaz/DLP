...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, T__41=42, T__42=43, T__43=44, INT_CONSTANT=45, 
		SIMPLE_COMMENT=46, MULTIPLE_COMMENT=47, CHAR_CONSTANT=48, WHITESPACES=49, 
		EXP=50, REAL_CONSTANT=51, ID=52;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SIMPLE_COMMENT", "MULTIPLE_COMMENT", "CHAR_CONSTANT", "WHITESPACES", 
			"EXP", "REAL_CONSTANT", "ID"
		};
	}
	...
	public final Func_bodyContext func_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 7100671862177856L) != 0)) {
				{
				{
				setState(131);
		...
		try {
			...
			case 3:
				...
				match(T__3);
				             ...
				             String op = (((StatementContext)_localctx).OP!=null?((StatementContext)_localctx).OP.getText():null).substring(0, 1);
				             _localctx.ast.add(new CompoundAssignment(
	...
	public final Func_invocationContext func_invocation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 7072058790051904L) != 0)) {
				{
				setState(296);
