...
public class TSmmParser extends Parser {
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public List<Expression> assignmentExpressions = new ArrayList<Expression>();
		public Token log;
		...
		try {
			...
			case 3:
				...
				((StatementContext)_localctx).e1 = expression(0);
				 _localctx.assignmentExpressions.add(((StatementContext)_localctx).e1.ast); 
				setState(257); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
					...
					((StatementContext)_localctx).e2 = expression(0);
					 _localctx.assignmentExpressions.add(((StatementContext)_localctx).e2.ast); 
					}
					}
					setState(259); 
					_errHandler.sync(this);
				...
				match(T__3);
				                ...
				                Expression rhs = _localctx.assignmentExpressions.get(_localctx.assignmentExpressions.size() - 1);

				                for (int i = _localctx.assignmentExpressions.size() - 2; i >= 0; i--) {
				                    Expression lhs = _localctx.assignmentExpressions.get(i);
				                    _localctx.ast.add(new Assignment(lhs.getLine(), lhs.getColumn(), lhs, rhs));
				                    rhs = lhs;
				                }
