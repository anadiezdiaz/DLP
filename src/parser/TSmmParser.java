...
public class TSmmParser extends Parser {
	...
	public final Func_definitionContext func_definition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 15032389632L) != 0)) {
				{
				setState(75);
	...
	public final Func_bodyContext func_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 443841920565312L) != 0)) {
				{
				{
				setState(131);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						((ExpressionContext)_localctx).ast =  new Logic(((ExpressionContext)_localctx).e1.ast.getLine(), ((ExpressionContext)_localctx).e1.ast.getColumn(), ((ExpressionContext)_localctx).e1.ast, ((ExpressionContext)_localctx).e2.ast, (((ExpressionContext)_localctx).OP!=null?((ExpressionContext)_localctx).OP.getText():null));
						}
						break;
					case 5:
						{
						...
						((ExpressionContext)_localctx).ast =  new Ternary(((ExpressionContext)_localctx).e1.ast.getLine(), ((ExpressionContext)_localctx).e1.ast.getColumn(), ((ExpressionContext)_localctx).e1.ast, ((ExpressionContext)_localctx).e2.ast, ((ExpressionContext)_localctx).e3.ast);
						}
						break;
					case 6:
						{
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(248);
				((StatementContext)_localctx).log = match(T__33);
				setState(249);
			...
			case 2:
				...
				{
				setState(253);
				((StatementContext)_localctx).input = match(T__34);
				setState(254);
				((StatementContext)_localctx).expression_list = expression_list();
				setState(255);
				match(T__3);
