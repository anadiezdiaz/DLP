...
public class TSmmParser extends Parser {
	...
	public final Func_bodyContext func_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 443841920761920L) != 0)) {
				{
				{
				setState(131);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 7:
						...
						match(T__14);
						setState(205);
						((ExpressionContext)_localctx).exp = match(INT_CONSTANT);

						                  if (LexerHelper.lexemeToInt((((ExpressionContext)_localctx).exp!=null?((ExpressionContext)_localctx).exp.getText():null)) != 2) {
						                      new ErrorType(((ExpressionContext)_localctx).exp.getLine(), ((ExpressionContext)_localctx).exp.getCharPositionInLine()+1,
						                          "Only square exponent (^2) is supported");
						                  }

						                  ((ExpressionContext)_localctx).ast =  new Square(((ExpressionContext)_localctx).e1.ast.getLine(), ((ExpressionContext)_localctx).e1.ast.getColumn(), ((ExpressionContext)_localctx).e1.ast);
	...
	public final Func_invocationContext func_invocation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 442003674759232L) != 0)) {
				{
				setState(294);
