	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				{
				setState(286);
				((StatementContext)_localctx).d = match(T__39);
				setState(287);
				((StatementContext)_localctx).b1 = block();
				setState(288);
				match(T__37);
				...
				setState(292);
				match(T__3);
				_localctx.ast.add(new DoWhileStatement(((StatementContext)_localctx).d.getLine(), ((StatementContext)_localctx).d.getCharPositionInLine()+1, ((StatementContext)_localctx).e1.ast, ((StatementContext)_localctx).b1.ast));
				}
				break;
			}
		}
