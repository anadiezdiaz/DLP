...
public class TSmmParser extends Parser {
	...
	public final Func_bodyContext func_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 443842994307136L) != 0)) {
				{
				{
				setState(131);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				setState(171);
				match(T__6);
				((ExpressionContext)_localctx).ast =  new Len(((ExpressionContext)_localctx).e1.ast.getLine(), ((ExpressionContext)_localctx).e1.ast.getColumn(), ((ExpressionContext)_localctx).e1.ast);
				}
				break;
			case 10:
				{
	...
	public final Func_invocationContext func_invocation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 442004748304448L) != 0)) {
				{
				setState(296);
